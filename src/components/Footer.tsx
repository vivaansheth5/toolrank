    ...
    <footer className="mt-24 border-t border-border bg-surface">
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          <div className="col-span-2 sm:col-span-1">
            <Link href="/" className="flex flex-col leading-tight">
              ...
              <span className="text-xs font-medium tracking-tight text-muted">Find the right tool &middot; Find the right deal</span>
            </Link>
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-border pt-6 text-xs text-muted sm:flex-row sm:items-center sm:justify-between">
          <p>© {new Date().getFullYear()} ToolDhundho.com. All rights reserved.</p>
          <p>ToolDhundho.com is currently an early product preview.</p>
        </div>
      </div>
    </footer>
  );
