...
export const metadata: Metadata = {
  ...
  description: "How ToolDhundho.com handles information in this product preview.",
};
      ...
      <div className="mt-8 space-y-8 text-foreground/80">
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            ToolDhundho.com is currently an MVP product preview. This build does not require an account, collect
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            &ldquo;Visit Website&rdquo; links take you to third-party tool providers. ToolDhundho.com is not
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            As ToolDhundho.com adds accounts, saved lists, or affiliate tracking in future versions, this policy
