    ...
    <>
      <section className="relative overflow-hidden border-b border-border">
        <div className="mx-auto max-w-4xl px-4 py-20 text-center sm:px-6 sm:py-28 lg:px-8">
          ...
          <div className="mt-8">
            <Link
              href="/find-my-tool"
              className="focus-ring inline-flex items-center gap-1.5 rounded-full bg-foreground px-5 py-2.5 text-sm font-medium text-white transition-colors hover:bg-foreground/85"
            >
              Find My Tool
              <ArrowRight size={15} />
            </Link>
      ...
      <section className="border-y border-border bg-foreground">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8">
          ...
          <Link
            href="/find-my-tool"
            className="focus-ring mt-7 inline-flex items-center gap-1.5 rounded-full bg-white px-5 py-2.5 text-sm font-medium text-foreground transition-colors hover:bg-white/90"
          >
            Find My Tool
            <ArrowRight size={15} />
          </Link>
