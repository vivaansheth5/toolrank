...
export const metadata: Metadata = {
  ...
  description: "Terms for using ToolDhundho.com in this product preview.",
};
      ...
      <div className="mt-8 space-y-8 text-foreground/80">
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            ToolDhundho.com, as presented here, is an early-stage MVP built to demonstrate a discovery product
        ...
        <section>
          ...
          <p className="mt-2 leading-relaxed">
            ToolDhundho.com links out to third-party products. Your use of any linked tool is governed by that
            provider&apos;s own terms, not ToolDhundho.com&apos;s.
          </p>
        </section>
      </div>
    </div>
